    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12 col-md-6">
                <app-breadcrumb :page-title="$t('address')" :directory="$t('datatables')" :icon="'grid'"/>
            </div>
        ...
        <address-modal v-if="isAddEditModalActive"
                       :table-id="tableId"
...
<script>
    ...
    import {TableHelpers} from "../mixins/AddressTableHelpers";
        ...
        methods: {
            ...
            getListAction(rowData, actionObj, active) {
                ...
                if (actionObj.title == 'Delete') {
                    ...
                    this.selectedUrl = `${actions.ADDRESS_DATA}/${rowData.id}`;
             ...
             */
            confirmed() {
                let url = `${actions.ADDRESS_DATA}/${this.rowData.id}`;
